...
#    tip_reticulating: "Reticulating spines."
    ...
    tip_munchkin: "Hvis du ikke spiser dine grøntsager, vil en muchkin komme efter dig mens du sover."
    tip_binary: "Der er kun 10 typer af personer i denne verden; dem der forstår binary, og dem der ikke gør."
    tip_commitment_yoda: "En programmør skal have den vildeste engagement og det mest alvorlige sind ~ Yoda"
    tip_no_try: "Gør, eller gør ikke. der er ingen mellemvej ~ Yoda"
    tip_patience: "Tålmodighed er du nødsaget til at have, unge Padawan- ~ Yoda"
    tip_documented_bug: "En dokumenteret fejl er ikke en fejl, det et træk"
